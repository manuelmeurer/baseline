# -*- encoding: utf-8 -*-
# stub: playwright-ruby-client 1.57.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "The Ruby binding of playwright driver 1.57.0".freeze
  ...
  s.add_runtime_dependency(%q<concurrent-ruby>.freeze, [">= 1.1.6".freeze])
  ...
  s.add_development_dependency(%q<faye-websocket>.freeze, [">= 0".freeze])
