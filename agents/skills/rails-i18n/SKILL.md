...
- When moving text from a view to I18n, first determine the language used in the view and move each text fragment to the corresponding namespaced I18n file, then translate each fragment into the other locales used in the namespace and add them to the correct I18n files.
