    ...
    module Lexoffice
      class UpsertContact < ApplicationService
        ...
        private
          ...
          def params
            person_or_company =
              @invoicing_details.company_name.present? ?
              {
                company: {
                ...
                person: {
                  salutation: t(@invoicing_details.gender, scope: :genders, locale: :de),
                  firstName:  @invoicing_details.first_name,
                  lastName:   @invoicing_details.last_name
                }
              }
