  ...
  module Wizardify
    ...
    included do
      ...
      before_action except: :success do
        if wizard_resource.finished? && !allow_edit_finished
      ...
      private
        ...
        helper_method def show_current_wizard_step = true
    end
    ...
    private
      ...
      def resource_params
        ...
        if params.key?(key)
          ...
          {}
        end.unless(wizard_resource.finished?) {
          _1.merge(form_step: current_step)
        }
      end
